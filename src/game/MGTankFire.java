...
public class MGTankFire extends InstantProjectile implements Drawable {
	
	static final int EFFECT_TIME = 20;
	static final Color COLOR = new Color(255, 224, 0);
	static final float THICKNESS = 1.8f;
	static final int DAMAGE = 1;
	static final float[] LINE_SHAPE = {4.0f, 12.0f};
	static final float PHASE_DIF = 1.3f;
	
	int time;
	float phase;
	
	public MGTankFire(Game game, TeamManager team, Unit owner, Unit target) {
